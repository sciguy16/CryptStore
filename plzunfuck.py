...
class MyWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.box.pack_start(self.decryptButton, True, True, 0)

        self.keySelector = Gtk.Button(label="Decrypt")
        self.keySelector.connect("clicked", self.on_keyselect_clicked)
        self.box.pack_start(self.keySelector, True, True, 0)

        link = Gtk.LinkButton("https://www.sucss.org/sucss2bu", "OnlineHelp")
        self.box.pack_start(link, True, True, 0)


    def on_keyselect_clicked(self,widget):
        print("Opening Key Selector")
        KeySelectWindow.show_all()
...
class decryptor(Gtk.Window):
    ...
    def add_filters(self, dialog):
        ...
        filter_any.add_pattern("*")
        dialog.add_filter(filter_any)
class keyselector(Gtk.Window):
    def __init__(self):
        self.set_border_width(10)
        Gtk.Window.__init__(self, title="Select a USB device, then hit continue, and select a key ")
        self.set_size_request(200, 100)
...
KeySelectWindow = keyselector()
KeySelectWindow.connect("delete-event", Gtk.main_quit)
